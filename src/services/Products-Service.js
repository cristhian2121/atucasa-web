...
export const GetProductStoreService = (idStore) =>
  apiBussines.get(`/product/?store=${idStore}`);

/* request get categories product */
export const getCategoryProductsService = () =>
  apiBussines.get(`/category_product/`);
